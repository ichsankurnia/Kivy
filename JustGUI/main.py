...
from JustGUI.database import DataBase
from JustGUI.pop import popRegist, popFinishTrain, popAbsen, popFinishAbs, popNotRecognized, popFinishTrainAgain, emptyForm
...
screens = [MainScreen(), LoginScreen(name="login"), RegisterScreen(), AbsenScreen(), OtherScreen()]
